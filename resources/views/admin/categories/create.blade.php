...
<div class="max-w-3xl mx-auto">
    ...
    <div class="glass-card p-10 border-none shadow-2xl shadow-slate-200/60">
        <div class="mb-10">
            <h3 class="text-2xl font-black text-slate-800 tracking-tight">Create New Category</h3>
            <p class="text-sm text-slate-600 font-medium">Add a generic category designation</p>
        </div>
        ...
        <form action="{{ route('categories.store') }}" method="POST" class="space-y-8">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" name="category_name" id="category_name" class="form-input-premium" placeholder="e.g. Standard Room, Sick Leave" value="{{ old('category_name') }}" required>
