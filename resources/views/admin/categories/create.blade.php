...
@section('header', 'Create Room Category')
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="glass-card p-10 border-none shadow-2xl shadow-slate-200/60">
        <div class="mb-10">
            <h3 class="text-2xl font-black text-slate-800 tracking-tight">Create New Room Category</h3>
            <p class="text-sm text-slate-600 font-medium">Add a room category designation</p>
        </div>
