        ...
        <form action="{{ route('categories.update', $category) }}" method="POST" class="space-y-8">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" name="category_name" id="category_name" class="form-input-premium" placeholder="e.g. Standard Room" value="{{ old('category_name', $category->category_name) }}" required>
