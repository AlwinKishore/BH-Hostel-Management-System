            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <input type="date" name="start_date" id="start_date" class="form-input-premium" value="{{ old('start_date', $batch->start_date) }}" required>
                    ...
                    <div>
                        ...
                        <input type="date" name="end_date" id="end_date" class="form-input-premium" value="{{ old('end_date', $batch->end_date) }}" required>
