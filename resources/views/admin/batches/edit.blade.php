        ...
        <form action="{{ route('batches.update', $batch) }}" method="POST" class="space-y-8">
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-center mt-4">
                    <input type="checkbox" name="is_current" id="is_current" class="w-5 h-5 text-indigo-600 rounded border-slate-300 focus:ring-indigo-500" {{ old('is_current', $batch->is_current) ? 'checked' : '' }}>
