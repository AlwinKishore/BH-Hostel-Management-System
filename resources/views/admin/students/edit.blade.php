                            ...
                            <div>
                                ...
                                <select name="academic_year_id" id="academic_year_id" class="form-input-premium appearance-none" required>
                                    ...
                                    @foreach($academicYears as $academicYear)
                                        <option value="{{ $academicYear->id }}" {{ old('academic_year_id', $student->academic_year_id) == $academicYear->id ? 'selected' : '' }}>{{ $academicYear->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select name="batch_id" id="batch_id" class="form-input-premium appearance-none" required>
                                    ...
                                    @foreach($batches as $batch)
                                        <option value="{{ $batch->id }}" data-academic-year-id="{{ $batch->academic_year_id }}" {{ old('batch_id', $student->batch_id) == $batch->id ? 'selected' : '' }}>{{ $batch->batch_name }}</option>
                                    @endforeach
                                </select>
